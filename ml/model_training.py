...
from ml.cnn_model import build_cnn_model, train_cnn_model, EMOTIONS
...
MODEL_PATH = 'models/cnn_emotions.keras'
EPOCHS = 30
BATCH_SIZE = 32
VAL_SPLIT = 0.2
...
print(f"Начало обучения CNN на {len(X)} примерах...")
...
print("График процесса обучения сохранен в models/cnn_training_history.png")
